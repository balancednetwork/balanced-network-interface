...
export const PRICE_IMPACT_WARNING_THRESHOLD = new Percent(250n, BIPS_BASE); //2.5%
export const PRICE_IMPACT_MODAL_WARNING_THRESHOLD = new Percent(500n, BIPS_BASE); //5%
export const PRICE_IMPACT_SWAP_DISABLED_THRESHOLD = new Percent(1000n, BIPS_BASE); //10%
