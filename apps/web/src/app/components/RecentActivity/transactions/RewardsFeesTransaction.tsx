...
interface RewardsFeesTransactionProps {
  transaction: XTransaction;
}

const RewardsFeesTransaction: React.FC<RewardsFeesTransactionProps> = ({ transaction }) => {
  ...
  return (
    <Container>
      <CurrencyLogoWithNetwork currency={inputXToken} chainId={'0x1.icon'} bgColor={theme.colors.bg2} size="26px" />
      <Details>
        <Title>Claim network fees </Title>
        {/* <Amount>
...
export default RewardsFeesTransaction;
