...
interface RewardsLPTransactionProps {
  transaction: XTransaction;
}

const RewardsLPTransaction: React.FC<RewardsLPTransactionProps> = ({ transaction }) => {
  ...
  return (
    <Container>
      ...
      />
      <Details>
        <Title>Claim liquidity rewards </Title>
        {/* <Amount>
...
export default RewardsLPTransaction;
