...
export enum MODAL_ID {
  ...
  MM_SWAP_CONFIRM_MODAL = 'MM_SWAP_CONFIRM_MODAL',
  ORDER_CONFIRM_MODAL = 'ORDER_CONFIRM_MODAL',
  MIGRATION_CONFIRM_MODAL = 'MIGRATION_CONFIRM_MODAL',
  //
  ...
  STELLAR_WALLET_OPTIONS_MODAL = 'STELLAR_WALLET_OPTIONS_MODAL',
  HAVAH_WALLET_OPTIONS_MODAL = 'HAVAH_WALLET_OPTIONS_MODAL',
  COSMOS_WALLET_OPTIONS_MODAL = 'COSMOS_WALLET_OPTIONS_MODAL',
  SUI_WALLET_OPTIONS_MODAL = 'SUI_WALLET_OPTIONS_MODAL',
  SOLANA_WALLET_OPTIONS_MODAL = 'SOLANA_WALLET_OPTIONS_MODAL',
  //
