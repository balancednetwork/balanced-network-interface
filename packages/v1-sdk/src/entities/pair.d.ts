import { BigintIsh, Price, Token, CurrencyAmount } from '@balancednetwork/sdk-core';
...
export declare class Pair {
    ...
    readonly totalSupply?: CurrencyAmount<Token>;
    readonly baseAddress?: string;
    static getAddress(tokenA: Token, tokenB: Token): string;
    constructor(currencyAmountA: CurrencyAmount<Token>, tokenAmountB: CurrencyAmount<Token>, additionalArgs?: {
        poolId?: number;
        totalSupply?: string;
        baseAddress?: string;
    });
