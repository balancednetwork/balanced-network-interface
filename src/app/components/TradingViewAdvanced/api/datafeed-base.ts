 ...
 */
export class DatafeedBase implements IExternalDatafeed, IDatafeedChartApi {
  ...
  protected constructor(datafeedURL: string, requester: Requester, updateFrequency: number = 10 * 1000) {
